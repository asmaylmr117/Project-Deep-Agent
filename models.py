...
# ═══ Default Models ══════════════════════════════════════════════════════════
# Check if a custom research model is specified in .env
research_model = os.getenv("RESEARCH_MODEL")
research_provider = os.getenv("RESEARCH_MODEL_PROVIDER")

if research_model and research_provider:
    model = init_chat_model(research_model, model_provider=research_provider, max_retries=10)
    strong_model = init_chat_model(research_model, model_provider=research_provider, max_retries=10)
else:
